                                        ...
                                        <form id="web-form1"  name="web-form1" action="/qa/form/edit.php" enctype="multipart/form-data"  method="POST">
                                            ...
                                            <table class="form-table">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="title" maxlength="128" class="required" title="&gt; Queston is required"! value="<?php echo $sticky->get('title',$questionDBRow['title']); ?>"/>
                                                    </td>
                                                 </tr>
                                                 ...
                                                 <tr>
                                                        ...
                                                        <td>
                                                            <textarea  name="description" class="h130" cols="50" rows="4" ><?php echo $sticky->get('description',$questionDBRow['description']); ?></textarea>
                                                        </td>
                                                 </tr>
                                                 <tr>
                                                    <td class="field">Location</td>
                                                    <td> <input type="text" name="location" maxlength="32" class="w200" minlength="3" value="<?php echo $sticky->get('location',$questionDBRow['location']); ?>" /></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input  type="text" name="tags" maxlength="64" class="required"  title="&gt; Tags are required!" value="<?php echo $sticky->get('tags',$questionDBRow['tags']); ?>" /></td>
                                                </tr>
